...
<form method="POST" action="{{ route('login')}}">
    ...
    <div class="form-group">
       ...
       <input name="email" class="form-control py-4 @error('email') is-invalid @enderror" id="input_login_email" value="{{ old('email') }}" type="email" placeholder="Enter email address" autocomplete="email"/>
       @error('email')
